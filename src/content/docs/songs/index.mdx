...
<LinkCard title="📑 Repository" description="Guidelines on how to add new sources" href="https://github.com/YARC-Official/OpenSource" />
<LinkCard title="🔎 Webviewer" description="Easiest way to visualize our current sources" href="https://opensource.yarg.in/" />

# 🗂️ Related Articles

<LinkCard title="💽 Official Setlist" description="Information about our Official Setlist" href="/songs/setlist" />
<LinkCard title="🎼 Charting Guidelines" description="Some guidelines on how to chart for YARG" href="/songs/charting" />
